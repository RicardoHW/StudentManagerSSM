    ...
    <script type="text/javascript">
        $(function(){
            ...
            $("#vcodeImg").click(function(){
                this.src="get_cpacha?vl=4&w=155&h=40&t="+new Date().getTime();
            });
        ...
        <form id="form" class="form form-horizontal" method="post">
            <div class="row cl">
                ...
                <div class="formControls col-8">
                    <input id="loginName" name="loginName" type="text" value="admin" placeholder="账户" class="input-text size-L">
                </div>
            </div>
            <div class="row cl">
                <label class="form-label col-3"><i class="Hui-iconfont">&#xe60e;</i></label>
                <div class="formControls col-8">
                    <input id="passWord" name="passWord" type="passWord" value="admin" placeholder="密码" class="input-text size-L">
                </div>
            </div>
            <div class="row cl">
                <div class="formControls col-8 col-offset-3">
                    <input class="input-text size-L" name="vcode" type="text" placeholder="系统调试中，暂勿需验证" style="width: 200px;">
                    <img title="点击图片切换验证码" id="vcodeImg" src="get_cpacha?vl=4&w=155&h=40"></div>
            </div>
...
<div class="footer">Copyright &nbsp; Ricardo @ Ricardo </div>
